    ...
    <style type="text/css">
      ...
      body #wrapper{
       ...
       #gm_fun_btn{
        ...
        .content{ width: 100%; }
        /* ================== 幻燈片 720環景 基本圖文 google地圖, 功能欄, youtube  ====================== */
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="all">
            <div class="content">
             ...
             <?php require_once '../../assets/php/tool_content.php';//頁面內容?>
    ...
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyDV1hk5SfQxLdftm38V5_3l4lY70jMg6w4&libraries=places"></script>
    <!-- 顏色十六進制轉HSL -->
