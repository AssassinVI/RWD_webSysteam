...
<head>
    ...
    <!-- test_btn -->
    <link rel="stylesheet" type="text/css" href="new_toolBar.css">
      ...
      $(document).ready(function() {
        var i=1;
         $("#tool_box_btn").click(function(event) {
           ...
           $("#gm_phl_btn").animate({left: "20%", bottom: "74px"}, 500);
           $("#gm_home_btn").animate({left: "27%", bottom: "127px"}, 500);
           $("#gm_food_btn").animate({left: "44%", bottom: "155px"}, 500);
           $("#gm_school_btn").animate({left: "61%", bottom: "127px"}, 500);
           $("#gm_fun_btn").animate({left: "69%", bottom: "74px"}, 500);
