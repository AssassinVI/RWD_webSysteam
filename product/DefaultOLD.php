...
<head>
    ...
    <!-- test_btn -->
    <link rel="stylesheet" type="text/css" href="test_btn.css">
    ...
    <style type="text/css">
      ...
      .content h2{
        color: <?php echo $color['h2_color'];?>;
       }
      .content p{
        color: <?php echo $color['p_color'];?>;
       }
      .marquee_box{
        color: <?php echo $color['marquee'];?>;
       }
       .big_txt b{
        color: <?php echo $color['top_txt'];?>;
       }
       .big_txt b:hover{
        color: <?php echo $color['h1_color'];?>;
       }
       header#topNav{
        background-color: <?php echo $color['top_bar'];?>;
        border-color: <?php echo $color['top_bar'];?>;
        box-shadow: none;
       }
      body #wrapper{
        background-color: <?php echo $color['back_color'];?>;
       }
...
<body>
    ...
    ?>
            ...
            <div id="nav_btn" class=" navbar-collapse nav-main-collapse collapse pull-right">
              ...
              <!-- 跑馬燈 -->
            <!--<div class="marquee_lay"></div>-->
            <marquee class="com_mar marquee_box"><?php echo $case['marquee']?></marquee>
    ...
    <footer class="dom_index">
        ...
        <div class="tool_box">
            ...
            <a id="phone_btn" class="tool_lay" href="tel:<?php echo $case['bu_phone'];?>" onclick="ga('send', 'event', 'phone_btn', 'click', 'tool_bar')"><span style="margin-top: 8px;" class="glyphicon glyphicon-earphone"></span><!--<img  src="assets/images/RWD/icom/04/icon1.png" alt="">--></a>

            <!-- 加LINE -->

            <a id="LINE_btn" class="tool_lay" href="<?php echo $bu_line;?>" onclick="ga('send', 'event', '加LINE或Line分享', 'click', 'tool_bar')"><img src="../../assets/images/RWD/icom/04/LINE.svg" alt=""></a>

            <!-- facebook分享 -->

            <a id="fb_btn" class="tool_lay" href="https://www.facebook.com/dialog/feed?app_id=563666290458260&display=popup&link=<?php echo $URL;?>&redirect_uri=https://www.facebook.com/" onclick="ga('send', 'event', 'fb分享', 'click', 'tool_bar')"> <img src="../../assets/images/RWD/icom/04/fb.svg" alt=""></a>

            <!-- GOOGLEMAP -->

            <a id="gm_btn" class="tool_lay" href="https://www.google.com/maps/dir//<?php echo $map_ps['map_position'];?>/@<?php echo $map_ps['map_position'];?>,17z/data=!4m5!1m4!3m3!1s0x0:0x0!2zMjXCsDAyJzE4LjkiTiAxMjHCsDE3JzM2LjEiRQ!3b1?hl=zh-TW" onclick="ga('send', 'event', 'map_btn', 'click', 'tool_bar')"><img src="../../assets/images/RWD/icom/04/map.svg" alt=""></a>

          <!-- GOOGLEMAP 食 -->

            <a id="gm_food_btn" class="tool_lay" href="https://www.google.com.tw/maps/search/餐廳/@<?php echo trim($map_ps['map_position']);?>,16z?hl=zh-TW" onclick="ga('send', 'event', 'map_btn', 'click', 'tool_bar')">食</a>

        </div>

        <!-- ===============================手機功能欄 按鈕========================================= -->
        <a id="tool_box_btn" href="#">功能</a>

        <!-- LINE按鈕 -->
        <a href="<?php echo $bu_line;?>" onclick="ga('send', 'event', '加Line', 'click', 'tool_bar')"><img  class="LINE_tool" src="../../assets/images/svg/line.svg" alt=""></a>
        
        <!-- FB按鈕 -->
        <a href="https://www.facebook.com/dialog/feed?app_id=563666290458260&display=popup&link=<?php echo $URL;?>&redirect_uri=https://www.facebook.com/" onclick="ga('send', 'event', 'fb分享', 'click', 'tool_bar')"><img  class="FB_tool" src="../../assets/images/svg/FB.svg" alt=""></a>
    ...
    $(function() {
       ...
       <?php 
          ...
          while ($row=mysql_fetch_array($result)) {
             ...
             $top_txt.='$("#nav_ul").find("b").removeClass("nav_active");';
             $top_txt.='$(this).find("b").addClass("nav_active");';
             $top_txt.='});';
...
/* ================================= 功能按鈕燈箱 ======================================= */
        ...
        $("#big_fb").hover(function() {

            ga('send', 'event', 'facebook讚', 'click', 'div');
      ...
      $(document).ready(function() {
        var i=1;
         $("#tool_box_btn").click(function(event) {
           ...
           $("#phone_btn").animate({left: "22%", bottom: "2px"}, 800);
           $("#LINE_btn").delay(200).animate({left: "29%", bottom: "62px"}, 800);
           $("#gm_food_btn").delay(400).animate({left: "45%", bottom: "92px"}, 800);
           $("#fb_btn").delay(600).animate({left: "61%", bottom: "62px"}, 800);
           $("#gm_btn").delay(800).animate({left: "69%", bottom: "2px"}, 800);
           
           }
           else{

           $("#phone_btn").animate({left: "44%", bottom: "0px"}, 1000);
           $("#LINE_btn").animate({left: "44%", bottom: "0px"}, 1000);
           $("#fb_btn").animate({left: "44%", bottom: "0px"}, 1000);
           $("#gm_btn").animate({left: "44%", bottom: "0px"}, 1000);
           $("#gm_food_btn").animate({left: "44%", bottom: "0px"}, 1000);
           }
